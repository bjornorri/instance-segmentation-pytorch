...
SEMANTIC_ANN_DIR = os.path.join(DATA_DIR, 'processed', 'microfibers', 'semantic-annotations')
INSTANCE_ANN_DIR = os.path.join(DATA_DIR, 'processed', 'microfibers', 'instance-annotations')
IMG_DIR = os.path.join(DATA_DIR, 'raw', 'microfibers',)
OUT_DIR = os.path.join(DATA_DIR, 'processed', 'microfibers', 'lmdb')
...
for subset in ['training', 'validation']:
    lst_filepath = os.path.join(DATA_DIR, 'metadata', 'microfibers', subset + '.lst')
