...
ANN_DIR = os.path.join(DATA_DIR, 'raw', 'microfibers')
IMG_DIR = os.path.join(DATA_DIR, 'raw', 'microfibers')
SEMANTIC_OUTPUT_DIR = os.path.join(DATA_DIR, 'processed', 'microfibers', 'semantic-annotations')
INSTANCE_OUTPUT_DIR = os.path.join(DATA_DIR, 'processed', 'microfibers', 'instance-annotations')
